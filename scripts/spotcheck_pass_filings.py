"""READ-ONLY silent-failure spot-check for PASS filings (JPM/DVN/PLD/NKE).
...
into the next item. Flags merged items and suspiciously short main items.
...
# main-item ids (no trailing letter) for the "suspiciously short" heuristic
def is_main(item_id):
...
def run_one(name):
    ...
    for it in result.items:
        ...
        # contiguity check: does this item start exactly where the previous ended?
        gapinfo = ""
